        ...
        <Container>
          <div className="grid grid-cols-1 items-start gap-10 lg:grid-cols-12">
            <div className="lg:col-span-7">
              <p className="text-[11px] uppercase tracking-[0.2em] text-secondary-foreground">Contact</p>
            ...
            <div className="flex flex-col items-start gap-7 lg:col-span-4 lg:col-start-9">
              <p className="max-w-[22rem] text-body leading-[1.85] text-secondary-foreground">
                {ctaContent.subtitle}
              </p>
