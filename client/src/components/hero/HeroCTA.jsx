  ...
  return (
    <Tag
      ...
      className={cn(
        ...
        compact
          ? 'max-w-full rounded-md border border-brand-yellow bg-brand-yellow px-4 py-2.5 sm:px-6 sm:py-3'
          : 'max-w-full rounded-md border border-brand-yellow bg-brand-yellow px-6 py-3.5 sm:px-8 sm:py-5',
        compact
          ? 'text-[0.75rem] font-semibold uppercase leading-none tracking-[0.13em] text-brand-ink sm:text-[0.8125rem] sm:tracking-[0.15em]'
